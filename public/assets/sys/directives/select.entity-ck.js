angular.module('app').directive("selectEntity", function($timeout) {
    ...
    return {
        ...
        template: '<input type="text" name="search" ng-model="entity_search" />\n
                    <input type="hidden" name="entity_type" ng-model="entity_type">\n
                    <input type="hidden" name="entity_id" ng-model="entity_id">';
