...
class RepositoryServiceProvider extends ServiceProvider {
    ...
    {
        $this->app->bind('Lion\Repositories\User\UserRepositoryInterface', 'Lion\Repositories\User\UserRepository');
    ...
    protected function entityBindings()
    {
        ...
        $this->app->bind('Lion\Repositories\Task\TaskRepositoryInterface',                  'Lion\Repositories\Task\TaskRepository');
        $this->app->bind('Lion\Repositories\Action\ActionRepositoryInterface',              'Lion\Repositories\Action\ActionRepository');
        $this->app->bind('Lion\Repositories\Entity\EntityRepositoryInterface',              'Lion\Repositories\Entity\EntityRepository');
    ...
    {
        $this->app->bind('Lion\Repositories\Config\Task\TaskConfigRepositoryInterface',                 'Lion\Repositories\Config\Task\TaskConfigRepository');
    ...
    protected function ajaxBindings()
    {
        ...
        //$this->app->bind('Lion\Controllers\Api\Ajax\ActionAjaxRepositoryInterface', 'Lion\Controllers\Api\Ajax\ActionAjaxRepository');
    }
