    ...
    'collections' => array(
        ...
        'application' => function($collection)
        {
            ...
            $directory = $collection->directory('assets/css', function($collection)
            {
                ...
                $collection->directory('select2', function($collection)
                {
                    $collection->stylesheet('select2.css');
                    $collection->stylesheet('select2-bootstrap.css');
                });
            });
            ...
            $directory = $collection->directory('assets/js', function($collection)
            {
                ...
                // Main libraries loading order
                $collection->javascript('jquery-2.0.3.min.js');
                $collection->javascript('angular.min.js');
                $collection->javascript('angular-resource.min.js');
                $collection->javascript('bootstrap/bootstrap.min.js');
                $collection->javascript('main.js');

                $d = $collection->directory('select2', function($collection) {
                    $collection->javascript('select2.min.js');
                    $collection->javascript('select2_locale_es.js');
                    $collection->javascript('select2.angular.js');
                });
        ...
        'timeline' => function($collection)
        {
            $directory = $collection->directory('assets/js/datepicker/', function($collection) {
                $collection->javascript('bootstrap-datetimepicker.min.js');
                $collection->javascript('locales/bootstrap-datetimepicker.es.js');
            });

            $directory->apply('JsMin');

            $directory = $collection->directory('assets/sys/controllers', function($collection) {
                $collection->javascript('timeline.js');
            });
        ...
        'datetimepicker' => function($collection) {
            $directory = $collection->directory('assets/js/datepicker/', function($collection) {
                $collection->javascript('bootstrap-datetimepicker.min.js');
                $collection->javascript('locales/bootstrap-datetimepicker.es.js');
            });
